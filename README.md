...
2. Circumventing Outliers of AutoAugment with Knowledge Distillation. (AutoAugment+KD, motivation:程度过大的augmentation会损害图像语义，再用hard label监督不合适，所以用teacher output监督)
