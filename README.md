...
9. ~~Structured Knowledge Distillation for _Semantic Segmentation_. Liu, Yifan et al. CVPR 2019~~ (semantic seg是一个结构性任务，所以针对性的KD就是pixel-pair similarity和holistic distillation)
